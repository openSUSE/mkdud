...
to apply the DUD to a Tumbleweed variant using Agama, use the *--installer* option.
...
There are currently Tumbleweed media with either Agama or YaST. Use the *--installer* option to specify for
